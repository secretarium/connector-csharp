...
namespace Secretarium.Client.Test
{
    ...
    public class TestMockedSecretarium
    {
        ...
        public void TestKeyExchange()
        {
            ...
            Assert.IsTrue(ServerHello.Parse(serverHello, out ServerHello serverHelloObj));
        ...
        private bool FullProtocolFromX509(out byte[] symmetricKey, out MockedSecretarium secretarium)
        {
            ...
            Assert.IsTrue(config.client.certificate.TryGetECDsaKey(out ECDsaCng clientECDsaCng));
